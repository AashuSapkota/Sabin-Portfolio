"""broadcast_platform URL Configuration
...
urlpatterns = [
    ...
    path('accounts/password_reset_complete.html',
...
handler400 = dash_views.error400
handler403 = dash_views.error403
handler404 = dash_views.error404
handler500 = dash_views.error500
